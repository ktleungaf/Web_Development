namespace SinExWebApp20273938.Migrations
{
    ...
    internal sealed class SinExConfiguration : DbMigrationsConfiguration<SinExWebApp20273938.Models.SinExDatabaseContext>
    {
        public SinExConfiguration()
        {
            AutomaticMigrationsEnabled = true;
            AutomaticMigrationDataLossAllowed = true;
            ContextKey = "SinExWebApp20273938.Models.SinExDatabaseContext";
        }

        protected override void Seed(SinExWebApp20273938.Models.SinExDatabaseContext context)
        {
            ...
            context.ServiceTypes.AddOrUpdate(
                ...
                new ServiceType { ServiceTypeID = 4, Type = "Next Day 15:00", CutoffTime = "9:00 p.m.", DeliveryTime = "Next day 3:00 p.m." },
                new ServiceType { ServiceTypeID = 5, Type = "2nd Day", CutoffTime = "", DeliveryTime = "5:00 p.m. second business day" },
                new ServiceType { ServiceTypeID = 6, Type = "Ground", CutoffTime = "", DeliveryTime = "1 to 5 business days depending upon origin and destination" }
                );
            ...
            context.ServicePackageFees.AddOrUpdate(
                ...
                new ServicePackageFee { ServicePackageFeeID = 9, Fee = 99, MinimumFee = 140, ServiceTypeID = 2, PackageTypeID = 4 }, // Box
            ...
            /* Not added because the notes said currencies should not be autogenerated
                        // Add currencies data.
            ...
            */
            ...
            new PackageTypeSize { PackageTypeSizeID = 1, SizeAndWeight = "(Size: 250x350mm; Weight Limit: Not Applicable)\n", PackageTypeID = 1 },
            new PackageTypeSize { PackageTypeSizeID = 2, SizeAndWeight = "(Size: small - 350x400mm; Weight Limit: 5kg)\n", PackageTypeID = 2 },
            new PackageTypeSize { PackageTypeSizeID = 3, SizeAndWeight = "(Size: large - 450x550mm; Weight Limit: 5kg)\n", PackageTypeID = 2 },
            new PackageTypeSize { PackageTypeSizeID = 4, SizeAndWeight = "(Size: 1000x80mm; Weight Limit: Not Applicable)\n", PackageTypeID = 3 },
            new PackageTypeSize { PackageTypeSizeID = 5, SizeAndWeight = "(Size: small - 300x250x150mm; Weight Limit: 10kg)\n", PackageTypeID = 4 },
            new PackageTypeSize { PackageTypeSizeID = 6, SizeAndWeight = "(Size: medium - 400x350x250mm; Weight Limit: 20kg)\n", PackageTypeID = 4 },
            new PackageTypeSize { PackageTypeSizeID = 7, SizeAndWeight = "(Size: large - 500x450x350mm; Weight Limit: 30kg)\n", PackageTypeID = 4 }
            );
            // Lab06 part 1 : comment out the Shipment code
                        //Lab03 part 1
                        // Add shipment data.
